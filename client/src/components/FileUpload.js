    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `0b99b0a3376ab4fa8ecd`,
            pinata_secret_api_key: `759b693a1a3a6377cfed614e366c573c986427b6e76018f4bc162d56326960ae`,
            "Content-Type": "multipart/form-data",
          },
        });
        const ImgHash = `https://azure-fashionable-lark-246.mypinata.cloud/ipfs/${resFile.data.IpfsHash}`;
